...
#define MyAppExeName "🚀 启动 DeepSeek Harness (推荐网页版).bat"
...
Name: "{group}\DeepSeek Harness (原生独立窗口)"; Filename: "{app}\🖥️ 启动桌面独立窗口.bat"; IconFilename: "{app}\runtime\resources\app\assets\deepseek.ico"
Name: "{group}\检查与更新"; Filename: "{app}\🔄 检查与更新.bat"
...
[Run]
Filename: "{app}\⚙️ 创建桌面图标与解除拦截.bat"; Parameters: "/silent"; Flags: runhidden
