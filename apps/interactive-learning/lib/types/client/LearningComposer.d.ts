...
import { type LearningActivityEnvelopeV1 } from '../protocol.ts';
export type LearningQuestionWait = PendingWait<'question'>;
export declare function envelopeOf(wait: LearningQuestionWait): LearningActivityEnvelopeV1 | undefined;
