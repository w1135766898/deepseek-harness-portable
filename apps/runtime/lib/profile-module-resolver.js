...
function packageManifestFromAnchor(anchor, packageName) {
 ...
 */
export function createProfileFirstPackageJsonResolver(profileDir, installAnchor) {
    ...
    return packageName => {
        ...
        throw new Error(`cannot resolve package manifest ${JSON.stringify(packageName)} from profile ${profileDir} or runtime ${installAnchor}`);
    };
}
//# sourceMappingURL=profile-module-resolver.js.map